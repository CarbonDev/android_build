...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
    ...
    patches from CarbonRom's Gerrit instance.
...
if args.topic:
    url = 'http://review.carbonrom.org/changes/?q=topic:%s' % args.topic
    if args.verbose:
...
for change in args.change_number:
    ...
    #   )]}'
    #   [ ... valid JSON ... ]
    url = 'http://review.carbonrom.org/changes/?q=%s&o=CURRENT_REVISION&o=CURRENT_COMMIT&pp=0' % change
    if args.verbose:
