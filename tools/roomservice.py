...
default_revison = "jb2"
dependency_filename = 'carbon.dependencies'
repositories = []
local_manifests = []
...
if not depsonly:
    print ("Device %s not found. Attempting to retrieve device repository from CarbonDev Github (http://github.com/CarbonDev)." % device)
...
if depsonly:
    ...
    for repository in repositories:
	    ...
	    final_name = "CarbonDev/" + repo_name
...
print ("Repository for %s not found in the CarbonDev Github repository list. If this is in error, you may need to manually add it to your local_manifests." % device)
